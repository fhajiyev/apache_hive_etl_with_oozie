...
set hivevar:interw_dt_from;
set hivevar:interw_dt_to;
...
INSERT INTO TABLE SVC_DS_DMP.PROD_DMP_ID_MATCHING partition(ID_TYPE)
 ...
 a.DMP_ID,
 REGEXP_REPLACE(a.DSP_COOKIE_ID, ' ', '+'),
 'uid017'
 ...
 WHERE
 (PART_HOUR BETWEEN '${hivevar:interw_dt_from}00' AND '${hivevar:interw_dt_to}24')
 AND
