...
set hivevar:mediamath_dt_from;
set hivevar:mediamath_dt_to;
...
INSERT INTO TABLE SVC_DS_DMP.PROD_DMP_ID_MATCHING partition(ID_TYPE)
 ...
 WHERE
 (PART_HOUR BETWEEN '${hivevar:mediamath_dt_from}00' AND '${hivevar:mediamath_dt_to}24')
 AND
 (DMP_UID IS NOT NULL AND DMP_UID <> '' AND SUBSTR(DMP_UID,1,6) = '(DMPC)' AND DMP_UID <> '(DMPC)00000000-0000-0000-0000-000000000000')
 AND
 (SITE_UID IS NOT NULL AND LENGTH(SITE_UID) IN (36,15))
 AND
 NID = '7'
