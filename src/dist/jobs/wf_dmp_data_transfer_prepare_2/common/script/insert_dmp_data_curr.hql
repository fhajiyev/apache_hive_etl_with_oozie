...
DROP TABLE IF EXISTS prod_user_segment_map_yestd;

ALTER TABLE prod_user_segment_map_today RENAME TO prod_user_segment_map_yestd;

CREATE TABLE SVC_DS_DMP_PI.PROD_USER_SEGMENT_MAP_TODAY
(
DMP_ID STRING,
...
INSERT INTO TABLE SVC_DS_DMP_PI.PROD_USER_SEGMENT_MAP_TODAY
...
FROM
   SVC_DS_DMP_PI.PROD_SEG_USER_VIEW a
