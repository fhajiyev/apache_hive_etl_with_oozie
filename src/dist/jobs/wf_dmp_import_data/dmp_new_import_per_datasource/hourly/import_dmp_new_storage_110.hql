...
-- OCB TUNE
  ...
  INSERT OVERWRITE TABLE dmp.prod_data_source_store PARTITION (part_hour='${hivevar:hour10before}', data_source_id='110')
  SELECT DISTINCT
  ...
  SELECT
        ...
        CASE
            WHEN LSID = '1021' THEN 'install'
            WHEN LSID = '1020' THEN 'open'
            WHEN LSID = '1028' THEN 'reinstall'
            WHEN LSID = '1029' THEN 'registration'
            WHEN LSID = '1030' THEN 'registration_anon'
        END
        AS ACTION,
  ...
  AND LSID IS NOT NULL AND LSID IN ('1020', '1021', '1028', '1029', '1030')
