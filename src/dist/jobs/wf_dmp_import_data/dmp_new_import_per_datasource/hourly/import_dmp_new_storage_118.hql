...
INSERT OVERWRITE TABLE dmp.prod_data_source_store PARTITION (part_hour='${hivevar:hourbefore}', data_source_id='118')
SELECT
      a.UID,
      a.REQUEST_DATE,
      a.REQUEST_TIME,
...
(
  ...
  log_time, '${hivevar:hourbefore}' as part_hour, '118' as data_source_id
