...
-- Recopick 삼성전자 행태 데이터

INSERT OVERWRITE TABLE dmp.prod_data_source_store PARTITION (part_hour='${hivevar:hourbefore}', data_source_id='137')
SELECT
      a.UID,
      a.REQUEST_DATE,
      a.REQUEST_TIME,
...
(
  ...
  log_time, '${hivevar:hourbefore}' as part_hour, '137' as data_source_id
