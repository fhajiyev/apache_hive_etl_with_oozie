...
-- DB손해보험
  ...
  INSERT OVERWRITE TABLE dmp.prod_data_source_store PARTITION (part_hour='${hivevar:hourbefore}', data_source_id='97')
  SELECT
  a.DMP_UID as uid,
  a.REQUEST_DATE,
  a.REQUEST_TIME,
  ...
  AND DSID IS NOT NULL AND DSID = '1003'
  ...
  SELECT
          ...
          if(get_json_object(BODY, '$.action') is null, '', get_json_object(BODY, '$.action')) AS ACTION,
