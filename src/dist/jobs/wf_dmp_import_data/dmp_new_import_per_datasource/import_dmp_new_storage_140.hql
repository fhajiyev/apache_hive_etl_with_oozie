...
-- 11st 기획전조회
  ...
  INSERT OVERWRITE TABLE dmp.prod_data_source_store PARTITION (part_hour='${hivevar:day2before}00', data_source_id='140')
...
FROM
11st_npi_skp.11st_npi_log_dmp_data_source_exhibition_view
