...
-- 11st 검색결과 클릭 데이터
  ...
  INSERT OVERWRITE TABLE dmp.prod_data_source_store PARTITION (part_hour='${hivevar:day2before}00', data_source_id='143')
SELECT
...
FROM
11st_npi_skp.11st_npi_log_dmp_data_source_searchresult_prdclick
