...
set hivevar:daycurr;
  ...
  INSERT INTO TABLE dmp_pi.prod_data_source_store PARTITION (part_hour, data_source_id)
  SELECT
  uid,
  ...
  '${hivevar:day2before}00',
  '${hivevar:day2before}00' as part_hour, datasourceid as data_source_id
  FROM svc_ds_dmp_pi.prod_audience_upload
  WHERE (parthour > '1999010100' and parthour <= '${hivevar:daybefore}23')
