...
set hive.exec.dynamic.partition.mode=nonstrict;
insert overwrite table dmp_pi.prod_data_source_store_parquet PARTITION (part_hour,data_source_id) select
uid,
  ...
  '${hivevar:day2before}00',
  data_source_id
from dmp_pi.prod_data_source_store where part_hour = '${hivevar:day3before}00';
