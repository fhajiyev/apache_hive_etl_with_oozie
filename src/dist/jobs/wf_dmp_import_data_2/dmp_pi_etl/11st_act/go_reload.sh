...
insert overwrite table dmp_pi.prod_data_source_store_alter partition (part_hour='${TARGET_JOB_DATE}00', data_source_id='9')
select distinct 
  u.ci                                                      as uid, 
  a.dt                                                      as col001, 
  ''                                                        as col002, 
...
run /app/di/script/run_hivetl.sh -e "alter table dmp_pi.prod_data_source_store_alter drop partition (part_hour < '${DROP_DATE}00', data_source_id='9');"
