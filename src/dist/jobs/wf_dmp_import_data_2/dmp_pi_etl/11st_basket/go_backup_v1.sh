...
etl_stat 'DOING'
run cp $DMP_PI_LOCAL_HOME/11st_disp_ct_dic.dat $DMP_PI_LOCAL_HOME/11st_basket/
print_bline
...
OUT_11ST_ORDER=$WORKDIR/temp_11st_purchase_17
...
OUT_ETL_11ST_ORDER=$WORKDIR/etl_11st_order_17
...
HIVEDIR2=$HIVEDIR1/data_source_id=17
