...
insert overwrite table dmp_pi.prod_data_source_store_alter partition (part_hour='${LAST_JOB_DATE_NOSLA}00', data_source_id='16')
...
#run /app/dmp_pi/dmp_pi_etl/11st_new_order/run_hivetl_alt.sh -f 11st_purchase_${LAST_JOB_DATE_NOSLA}.hql

/app/di/qcshell/bin/qcshell -b eda-hive2 -f 11st_purchase_${LAST_JOB_DATE_NOSLA}.hql

run /app/di/script/run_hivetl.sh -e "alter table dmp_pi.prod_data_source_store_alter drop partition (part_hour < '${DROP_DATE}00', data_source_id='16');"
