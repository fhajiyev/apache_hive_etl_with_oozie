...
cd /app/dmp_pi/dmp_pi_etl/demo_sw
./go.sh

END_TIME=`date '+%s'`
cd $STATS_DIR
run ./dmp_timing_meta.sh 20 $END_TIME_PREV $END_TIME


END_TIME_PREV=$END_TIME

cd /app/dmp_pi/dmp_pi_etl/demo_ocb
./go.sh

END_TIME=`date '+%s'`
cd $STATS_DIR
run ./dmp_timing_meta.sh 19 $END_TIME_PREV $END_TIME


END_TIME_PREV=$END_TIME

cd /app/dmp_pi/dmp_pi_etl/demo_11st
./go.sh

END_TIME=`date '+%s'`
cd $STATS_DIR
run ./dmp_timing_meta.sh 18 $END_TIME_PREV $END_TIME
